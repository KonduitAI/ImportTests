...
def test_mathtransform():
    ops = [
        ...
        #{"opName": "log_softmax", "outName": "log_softmax/rank2_float32", "varShapes":[[1,2]], "varTypes":["float32"], "varInit":["uniform"]},
        #{"opName": "log_softmax", "outName": "log_softmax/rank2_float64", "varShapes": [[1, 2]], "varTypes": ["float64"], "varInit": ["uniform"]},
        #{"opName": "log_softmax", "outName": "log_softmax/rank2_half", "varShapes": [[1, 2]], "varTypes": ["half"], "varInit": ["uniform"]},
        #{"opName": "log_softmax", "outName": "log_softmax/rank2_float32_with_axis", "varShapes": [[1, 2],[]],"varTypes": ["float32","int32"], "varInit": ["uniform","zero"]},
        #{"opName": "log_softmax", "outName": "log_softmax/rank2_float64_with_axis", "varShapes": [[1, 2],[]],"varTypes": ["float64","int32"], "varInit": ["uniform","zero"]},
        #{"opName": "log_softmax", "outName": "log_softmax/rank2_half_with_axis", "varShapes": [[1, 2],[]], "varTypes": ["half","int32"], "varInit": ["uniform","zero"]},
        #{"opName": "log_softmax", "outName": "log_softmax/rank3_float32", "varShapes": [[1, 2, 3],], "varTypes": ["float32"], "varInit": ["uniform"]},
        #{"opName": "log_softmax", "outName": "log_softmax/rank3_float64", "varShapes": [[1, 2, 3]], "varTypes": ["float64"], "varInit": ["uniform"]},
        #{"opName": "log_softmax", "outName": "log_softmax/rank3_half", "varShapes": [[1, 2, 3]], "varTypes": ["half"], "varInit": ["uniform"]},
        #{"opName": "log_softmax", "outName": "log_softmax/rank4_float32", "varShapes": [[1, 2, 3, 2]], "varTypes": ["float32"], "varInit": ["uniform"]},
        #{"opName": "log_softmax", "outName": "log_softmax/rank4_float64", "varShapes": [[1, 2, 3, 2]], "varTypes": ["float64"], "varInit": ["uniform"]},
        #{"opName": "log_softmax", "outName": "log_softmax/rank4_half", "varShapes": [[1, 2, 3, 2]], "varTypes": ["half"], "varInit": ["uniform"]},
